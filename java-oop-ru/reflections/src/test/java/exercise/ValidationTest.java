...
class ValidationTest {
    ...
    public void testAdvancedValidate() {
        ...
        var expected1 = List.of("length less than 4");
        var expected2 = List.of("can not be null");
        assertThat(expected1).isEqualTo(actual.get("country"));
        assertThat(expected2).isEqualTo(actual.get("street"));
    }
    // END
}
